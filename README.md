...
- Taxi ride data (two XML files)
	- [https://adfdemostorageacctbp.blob.core.windows.net/yellow/xml/part-00000.xml](https://adfdemostorageacctbp.blob.core.windows.net/yellow/xml/part-00000.xml)
	- [https://adfdemostorageacctbp.blob.core.windows.net/yellow/xml/part-00001.xml](https://adfdemostorageacctbp.blob.core.windows.net/yellow/xml/part-00001.xml)
- Payment Lookup
	- [https://adfdemostorageacctbp.blob.core.windows.net/yellow/lookup/payment\_lookup.csv](https://adfdemostorageacctbp.blob.core.windows.net/yellow/lookup/payment_lookup.csv)
- Zone Lookup
	- [https://adfdemostorageacctbp.blob.core.windows.net/yellow/lookup/yellow\_zone\_lookup.csv](https://adfdemostorageacctbp.blob.core.windows.net/yellow/lookup/yellow_zone_lookup.csv)
